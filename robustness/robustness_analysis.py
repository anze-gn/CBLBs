...
if __name__ == "__main__":
    ...
    base_paths_opt = [os.path.join("results_optimization", "cblb"), os.path.join("results_optimization", "0cblb")]
    ...
    #df = getParamDistrib(file_name=os.path.join("results_robustness", "params.csv"))
    df = pd.read_csv(os.path.join("results_robustness", "params.csv"))
    plotParamsdf(df)
